            ...
            <div class="w-[500px] p-4 rounded">
                <div class="border-b pb-4">
                    ...
                    <div class="mb-4">
                        ...
                        @if($comment->image)
                        <div class="relative w-full mt-4" style="padding-bottom: 50%;">
                            <img src="{{ url('post/' . basename($comment->image)) }}" alt="コメント画像" class="absolute top-0 left-0 w-full h-full object-cover">
                        </div>
                        @endif
                    </div>
                    @endforeach
...
<script src="http://jokey-three.vercel.app/js/comment/app.js"></script>
@endsection